...
#endif
#ifndef LIBRARIES
#define LIBRARIES       0xa0004800      /* start address of libraries locate group */
#endif
#ifndef INTTAB
#define INTTAB          0xa0004C00      /* start address of interrupt table */
#endif
#ifndef TRAPTAB
#define TRAPTAB         0xa0004E00      /* start address of trap table */
#endif
#ifndef CSA_START
...
#ifdef __CPU_TC043__
                map (src_offset=0x00000000, dest_offset=0x00000000, size=256M-16, dest=bus:fpi_bus);
                map (src_offset=0x10000000, dest_offset=0x10000000, size=256M-16, dest=bus:fpi_bus);
                map (src_offset=0x20000000, dest_offset=0x20000000, size=256M-16, dest=bus:fpi_bus);
                map (src_offset=0x30000000, dest_offset=0x30000000, size=256M-16, dest=bus:fpi_bus);
                map (src_offset=0x40000000, dest_offset=0x40000000, size=256M-16, dest=bus:fpi_bus);
                map (src_offset=0x50000000, dest_offset=0x50000000, size=256M-16, dest=bus:fpi_bus);
                map (src_offset=0x60000000, dest_offset=0x60000000, size=256M-16, dest=bus:fpi_bus);
                map (src_offset=0x70000000, dest_offset=0x70000000, size=256M-16, dest=bus:fpi_bus);
                map (src_offset=0x80000000, dest_offset=0x80000000, size=256M-16, dest=bus:fpi_bus);
                map (src_offset=0x90000000, dest_offset=0x90000000, size=256M-16, dest=bus:fpi_bus);
                map (src_offset=0xa0000000, dest_offset=0xa0000000, size=256M-16, dest=bus:fpi_bus);
                map (src_offset=0xb0000000, dest_offset=0xb0000000, size=256M-16, dest=bus:fpi_bus);
                map (src_offset=0xc0000000, dest_offset=0xc0000000, size=256M-16, dest=bus:fpi_bus);
                map (src_offset=0xd0000000, dest_offset=0xd0000000, size=256M-16, dest=bus:fpi_bus);
                map (src_offset=0xe0000000, dest_offset=0xe0000000, size=256M-16, dest=bus:fpi_bus);
                map (src_offset=0xf0000000, dest_offset=0xf0000000, size=256M-16, dest=bus:fpi_bus);
#else
