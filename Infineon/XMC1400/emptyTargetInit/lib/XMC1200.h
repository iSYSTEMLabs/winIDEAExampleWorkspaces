 ...
 *           from CMSIS SVD File 'XMC1200_Processed_SVD.xml' Version 1.0.5 (Reference Manual v1.0),
 *******************************************************************************************************/
...
typedef struct {                                    /*!< (@ 0x40010500) COMPARATOR Structure                                   */
  ...
  __I  uint32_t  RESERVED0[342];
  __IO uint16_t  ANACMP0;                           /*!< (@ 0x40010A5C) Analog Comparator 0 Control Register                   */
  __I  uint16_t  RESERVED1;
  __IO uint16_t  ANACMP1;                           /*!< (@ 0x40010A60) Analog Comparator 1 Control Register                   */
  __I  uint16_t  RESERVED2;
  __IO uint16_t  ANACMP2;                           /*!< (@ 0x40010A64) Analog Comparator 2 Control Register                   */
} COMPARATOR_Type;
