...
#endif
#ifndef RESET
#define RESET           0xA40A0020      /* reset address */
#endif
#ifndef LIBRARIES
#define LIBRARIES       0xA40A0800      /* start address of libraries locate group */
#endif
#ifndef INTTAB
#define INTTAB          0xA40A0C00      /* start address of interrupt table */
#endif
#ifndef TRAPTAB
#define TRAPTAB         0xA40A0E00      /* start address of trap table */
#endif
#ifndef APPLICATION
#define APPLICATION     0xA40A1000      /* start address of application */
#endif
#ifndef CSA_START
...
architecture TC
{
        ...
        space linear
        {
                ...
                section_layout
                {
                        group startup (ordered, contiguous, run_addr=(RESET))
                        {
...
#  endif
                        ...
                        group application (ordered, contiguous, run_addr=(APPLICATION))
                        {
                                select ".text.*";
                        }
                }
