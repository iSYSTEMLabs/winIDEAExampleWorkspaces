...
/* system timer bits */
#define STM0_INT_PRI      0x5


#define COREID_REG 0xFE1C
// Cores info
#define MAX_CORES 6
#define ID_CORE_0 0
#define ID_CORE_1 1
...
#define BOOT_ADDR (unsigned long)_START0

/* 
*  Common variables, defined in linker file.
*  For syncing and inter-core communication 
*/
...
extern unsigned char g_cUninitializedVariable;
extern unsigned char g_cInitializedVariable;


void initTimer();
void InterruptRoutine(void);
void syncCoreToCPU0(void);
