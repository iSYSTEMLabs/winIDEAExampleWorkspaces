...
unsigned char g_FlashConfig[FLASHCONFIG_BYTE_SIZE] =
{
  ...
  0x00,  // 0x02 - GPIO_Conf
  0x00,  // 0x03 - Not used
  0x9C,  // 0x04 - CRC16       // calculated from bytes 0..3
  0xDD,  // 0x05 - CRC16       // calculated from bytes 0..3  https://crccalc.com/?crc=22430000&method=crc8&datatype=hex&outtype=hex
  0x00,  // 0x06 - Not used
  0x00,  // 0x07 - Not used
  0x00,  // 0x08 - Not used
  0x00,  // 0x09 - Not used
