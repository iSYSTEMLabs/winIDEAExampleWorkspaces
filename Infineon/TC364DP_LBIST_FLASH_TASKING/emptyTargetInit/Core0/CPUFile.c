...
{ 
  ...
  SCU_CCUCON0 = 0x47230113; // Step 5: switch CCU input clock to PLL via CCUCON0.CLKSEL
...
void initInterrupts()
{
  ...
  STM0_CMCON |= 0x0F; // Number of bits in CMP0 used to compare 
...
void targetInit(void)
{
  ...
  /* We skip clock initialization in order to use LBIST executions, clock is 100MHz by default */
  //clockInit();
  enableSecondCore();
  initInterrupts();
