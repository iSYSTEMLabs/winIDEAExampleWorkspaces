...
#define STM0_CMP0 (*(unsigned long volatile *)(STM0_BASE + 0x30))
#define STM0_CMCON (*(unsigned long volatile *)(STM0_BASE + 0x38))
#define STM0_ICR (*(unsigned long volatile *)(STM0_BASE + 0x3C))
#define STM0_ISCR (*(unsigned long volatile *)(STM0_BASE + 0x40))
...
extern void enableSecondCore();
void delayFunction(unsigned volatile int n);
