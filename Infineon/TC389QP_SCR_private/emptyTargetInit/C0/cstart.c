...
{       
        ...
        /* THIS PART IS CONFIGURES SCR STANDALONE MODE. THIS CODE MUST BE EXECUTED BEFORE MAIN
           OTHERWISE THE DEVICE FREEZES BUT ONLY IN STANDALONE MODE!!!*/
         
        /*Clear SCRCFG*/
        PMS_PMSWCR4 &= ~(0xFF << PMS_SCRCFG);
        /*Set SCR mode to private DAP*/
        PMS_PMSWCR4 |= (0x2 << PMS_SCRCFG);
        
        /*Reset IOCR register (mode register)*/
        P33_IOCR4 = 0x00000000;
        /*Set pin 33.6 for SCR private DAP*/
        P33_IOCR4 |= (6 << 19);
        /*Set pin 33.7 for SCR private DAP*/
        P33_IOCR4 |= (6 << 27);
        
        /*Set pin 33.6 and 33.7 as SCR pins*/
        P33_PCSR = 0x0000000;
        P33_PCSR |= (1 << 6);
        P33_PCSR |= (1 << 7);
