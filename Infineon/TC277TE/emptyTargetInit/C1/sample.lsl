...
#endif
#ifndef RESET
#define RESET           0xa0001500      /* reset address */
#endif
#ifndef LIBRARIES
#define LIBRARIES       0xa0022000      /* start address of libraries locate group */
#endif
#ifndef INTTAB
#define INTTAB          0xa0020000      /* start address of interrupt table */
#endif
#ifndef TRAPTAB
#define TRAPTAB         0xa0021000      /* start address of trap table */
#endif
#ifndef CSA_START
...
architecture TC1V1.3
{
        ...
        space csa
        {
                ...
                map (src_offset=0xd0004000, dest_offset=0xd0004000, size=4M, dest=space:linear);
                section_layout
                {
...
derivative tc277
{
        ...
        memory pflash1
        {
                ...
                size = 0x1000;
                type = rom;
                map (dest=bus:tc:fpi_bus, dest_offset=0xa0001300, size=0x1000);
        }
        ...
        memory pflash2
        {
                ...
                size = 0x10000;
                type = rom;
                map (dest=bus:tc:fpi_bus, dest_offset=0xa0020000, size=0x10000);
        }
