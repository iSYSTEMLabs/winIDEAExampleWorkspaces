...
#define P33_IOCR4  	(*(unsigned long volatile *)(0xF003D314))
#define P33_OUT 	  (*(unsigned char volatile *)(0xF003D300))
#define SRC_STM2SR0	(*(unsigned long volatile *)(0xF00384A0))
#define SRC_STM2SR1 (*(unsigned long volatile *)(0xE00384A4))

//TODO
#define P01_OUT 	  (*(unsigned char volatile *)(0xF003A100))
...
#define CBS_OCNTRL            (*(unsigned long volatile *)0xF000047C)