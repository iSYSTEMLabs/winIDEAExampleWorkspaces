...
void _START( void )
{
  __asm (".word 0xA0000030");
  __asm (".word 0xb3590078"); /* Magic + HWCFG=Internal start from Flash, Mode selection by HWCFG pins is disabled */
  __asm (".word 0x00000000");
  __asm (".word 0x00000000");
  __asm (".word 0x00000000");
  __asm (".word 0x00000000");
  __asm (".word 0xF04DCBDE");
  __asm (".word 0x0FB23421");        
      
  __asm("nop");  //rt BreakPoint: id=testLatchAndStopReset
