...
/*
Product Name    SAK-TC377TX-96F300S (Step AA)
Chip ID     0xA9017780
Cores/Checker Cores     3/3
Max. Freq. (MHz)      300
Program Flash (MB)      6
Data Flash0 (single-ended) (KB)     256
Total SRAM (without EMEM) (KB)      992
EMEM Size (KB)      3072
DSPR (KB)       240 in CPU0&1; 96 other
DLMU (KB)       64 per CPU
PSPR (KB)       64
LMU (KB)        0
DAM (KB)        32
QSPI Modules/with LVDS      5/2
MCDS Availability     MCDS
...
void clock_Switch()
{
  ...
  // NOTE: If program execution does not pass following line, make sure that jumper configuration on emulation
  // adapter (if used) is properly configured.
