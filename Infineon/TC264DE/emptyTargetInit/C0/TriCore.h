...
#define P33_IOCR8  	(*(unsigned long volatile *)(0xF003D318))
#define P33_OUT 	  (*(unsigned char volatile *)(0xF003D301))
...
#define SCU_PLLCON1_K2DIV 0 

#define STM_CMP0 (*(unsigned int volatile *)(0xF0000030))
#define STM_CMP1 (*(unsigned int volatile *)(0xF0000034))
#define STM_CMCON (*(unsigned int volatile *)(0xF0000038))
#define STM_CMCON_MSTART0 8
#define STM_CMCON_MSIZE0 0
#define STM_ICR (*(unsigned int volatile *)(0xF000003C))
#define STM_ICR_CMP1IR 5
#define STM_ICR_CMP0IR 1
#define STM_ICR_CMP0EN 0
#define STM_ISCR (*(unsigned int volatile *)(0xF0000040))
#define STM_ISCR_CMP1IRR 2
#define STM_ISCR_CMP0IRR 0
