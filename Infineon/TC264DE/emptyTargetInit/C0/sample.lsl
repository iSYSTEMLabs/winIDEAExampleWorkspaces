...
#endif
#ifndef LIBRARIES
#define LIBRARIES       0xa0003000      /* start address of libraries locate group */
#endif
#ifndef INTTAB
#define INTTAB          0xa0002C00      /* start address of interrupt table */
#endif
#ifndef TRAPTAB
#define TRAPTAB         0xa0002E00      /* start address of trap table */
#endif
#ifndef CSA_START
...
derivative tc277
{
        ...
        memory pflash1
        {
                ...
                size = 0x1000;
                type = rom;
                map (dest=bus:tc:fpi_bus, dest_offset=0xa0000000, size=0x1000);
        }
        ...
        memory pflash2
        {
                ...
                size = 0x8000;
                type = rom;
                map (dest=bus:tc:fpi_bus, dest_offset=0xa0002000, size=0x8000);
        }
        ...
        memory pram
        {
                ...
                size = 14k;
                type = ram;
                map (dest=bus:tc:fpi_bus, dest_offset=0xf0000000, size=14k);
        }
