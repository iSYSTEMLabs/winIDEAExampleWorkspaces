...
#endif
#ifndef RESET
#define RESET           0xa0001000      /* reset address */
#endif
#ifndef LIBRARIES
#define LIBRARIES       0xa000B000      /* start address of libraries locate group */
#endif
#ifndef INTTAB
#define INTTAB          0xa000AC00      /* start address of interrupt table */
#endif
#ifndef TRAPTAB
#define TRAPTAB         0xa000AE00      /* start address of trap table */
#endif
#ifndef CSA_START
...
architecture TC1V1.3
{
        ...
        space csa
        {
                ...
                map (src_offset=0xd0000000, dest_offset=0xd0003000, size=4M, dest=space:linear);
                section_layout
                {
...
derivative tc277
{
        ...
        memory pflash1
        {
                ...
                size = 0x1000;
                type = rom;
                map (dest=bus:tc:fpi_bus, dest_offset=0xa0001000, size=0x1000);
        }
        ...
        memory pflash2
        {
                ...
                size = 1504k;
                type = rom;
                map (dest=bus:tc:fpi_bus, dest_offset=0xa000A000, size=1504k);
        }
