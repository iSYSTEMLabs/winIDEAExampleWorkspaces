...
#endif
#ifndef LIBRARIES
#define LIBRARIES       0xa0008000      /* start address of libraries locate group */
#endif
#ifndef INTTAB
#define INTTAB          0xa0009000      /* start address of interrupt table */
#endif
#ifndef TRAPTAB
#define TRAPTAB         0xa0009E00      /* start address of trap table */
#endif
#ifndef CSA_START
...
derivative tc277
{
        ...
        memory pflash1
        {
                ...
                size = 0x1000;
                type = rom;
                map (dest=bus:tc:fpi_bus, dest_offset=0xa0003900, size=0x1000);
        }
        ...
        memory pflash2
        {
                ...
                size = 24k;
                type = rom;
                map (dest=bus:tc:fpi_bus, dest_offset=0xa0008000, size=24k);
        }
