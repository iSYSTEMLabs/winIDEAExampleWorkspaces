...
#define P33_IOCR4        *(unsigned volatile long*) 0xF003C114
#define P33_OUT          *(unsigned volatile long*) 0xF003C100
#define P33_OMR          *(unsigned volatile long*) 0xF003C104

#define SCU_OSCCON_MODE_0       5
#define SCU_OSCCON_MODE_1       6
#define SCU_OSCCON_OSCVAL       16

#define SCU_OSCCON_PLLLV        1
#define SCU_OSCCON_PLLHV        8

#define SCU_SYSPLLSTAT_LOCK     2

#define SCU_PERPLLSTAT_LOCK     2

#define SCU_SYSPLLCON0_INSEL    30

#define SCU_SYSPLLCON0_PLLPWD   16
#define SCU_SYSPLLCON1_K2DIV_0  0

#define SCU_PERPLLCON0_PLLPWD   16

#define SCU_PERPLLCON1_K2DIV_0  0

#define SCU_PERPLLCON1_K3DIV_0  8

#define SCU_CCUCON0_CLKSEL_0    28
#define SCU_CCUCON0_UP          30
#define SCU_CCUCON0_LCK         31
...
#define GPT120_CLC_DISR        0
#define GPT120_CLC_DISS        1

#define GPT120_T3CON_T3R        6
#define GPT120_T3CON_BPS1_0     11
#define GPT120_T3CON_BPS1_1     12

#define GPT120_T4CON_T4I        0
#define GPT120_T4CON_T4M        3  
