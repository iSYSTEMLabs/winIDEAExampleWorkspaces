...
void isystem_sft_dbpush_r28(int value)
{
  __asm("prepare {r28},0"); // Saves R28 register.    
  __asm("mov r6, r28");     // Move value from R6 (ABI) to R28.
  __asm("dbpush r28,r28");  // Output R28 register via SFT.
  __asm("dispose 0,{r28}"); // Restore R28 register 
}