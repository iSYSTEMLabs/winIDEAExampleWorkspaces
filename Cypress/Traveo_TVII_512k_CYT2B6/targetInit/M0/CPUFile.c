...
// Current trace configuration is for newest chip revision, on M4 core.
...
void enterAndExitStopMode()
{
  ...
  */
  ...
  BACKUP_REG_0 = 0x12341234;
  PWR_HIBERNATE = 0x800A3A00;
  PWR_HIBERNATE = 0x800A3A00;
  PWR_HIBERNATE = 0x800A3A00;
  __asm volatile ("wfi");
} 
...
void enableLPMInterrupts()
{
  ...
  // Enable interrupts for TCPWM GRP2 CNT0 (32-bit) for ZTE1572 (chip 832ZZ279)
  CM0_SYSTEM_INT_CTL_348 |= (0x3 << CM0_SYSTEM_INT_CTL_348_INT_IDX);
  CM0_SYSTEM_INT_CTL_348 |= (0x1 << CM0_SYSTEM_INT_CTL_348_INT_VALID);
  NVIC_ISER_0 |= (0x1 << NVIC_ISER_2_TCPWM); 
  // Enable interrupts for TCPWM GRP2 CNT0 (32-bit) for ZTE1623 (chip 907ZZ338)
  CM0_SYSTEM_INT_CTL_349 = 0x0;
  CM0_SYSTEM_INT_CTL_349 |= (0x7 << CM0_SYSTEM_INT_CTL_349_INT_IDX);
  CM0_SYSTEM_INT_CTL_349 |= (0x1 << CM0_SYSTEM_INT_CTL_349_INT_VALID);
  NVIC_ISER_0 |= (0x1 << NVIC_ISER_2_TCPWM);
  
  // RTC Interrupts are the same for both chips/boards
