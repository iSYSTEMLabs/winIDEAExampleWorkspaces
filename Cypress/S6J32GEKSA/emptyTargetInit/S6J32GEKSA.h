#ifndef __S6J32GEKSA__
#define __S6J32GEKSA__
/*
...
#define IRC0_IRQPL44 (*(unsigned volatile int*) 0xB0400165D)	  // Priority register 

/*
  GPIO registers   
*/

#define PPC_PCFGR404 (*(unsigned volatile int*)0xB4740108)		  // Port configuration register
#define PPC_KEYCDR (*(unsigned volatile int*)0xB4740400)          // PPC Key Code Register                                      // Low 15 bits of address of corresponding register
#define GPIO_KEYCDR (*(unsigned volatile int*)0xB4738404)         // GPIO Key Code Register
#define GPIO_BASE       (unsigned int) 0xB4738000
#define GPIO_DDR4		(*(unsigned int *) (GPIO_BASE + 0x224))		// Data direction register
#define GPIO_PODR4 		(*(unsigned int *) (GPIO_BASE + 0x220)) 	// Data register
...
#define HWDG_BASE (unsigned int) 0xB060C000
#define HWDG_PROT (*(unsigned int *) 	HWDG_BASE)
#define HWDG_KEY 0xEDACCE55
#define HWDG_CNT  (*(unsigned int *) 	(HWDG_BASE + 0x8))
#define HWDG_TRG0 (*(unsigned int *) 	(HWDG_BASE + 0x10))
#define HWDG_TRG0CFG (*(unsigned int *) (HWDG_BASE + 0x2C))
#define HWDG_TRG1 (*(unsigned int *) 	(HWDG_BASE + 0x18))
#define HWDG_TRG1CFG (*(unsigned int *) (HWDG_BASE + 0x30))
#define HWDG_CFG (*(unsigned int *) 	(HWDG_BASE + 0x48))

#endif // __S6J32GEKSA__