...
#define PERI_CLOCK_CTL_116 (*(volatile unsigned int*)0x40000DD0)
...
#define CM0_SYSTEM_INT_CTL_375 (*(volatile unsigned int*)0x402085DC)
#define CM0_SYSTEM_INT_CTL_375_INT_IDX 0
#define CM0_SYSTEM_INT_CTL_375_INT_VALID 31
