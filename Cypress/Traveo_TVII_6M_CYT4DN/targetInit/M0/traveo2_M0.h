...
#define CM0_SYSTEM_INT_CTL_552   (*(volatile unsigned int*)0x402088A0)
#define CM0_SYSTEM_INT_CTL_552_INT_IDX 0
#define CM0_SYSTEM_INT_CTL_552_INT_VALID 31
...
#define PERI_CLOCK_CTL_2 (*(volatile unsigned int*)0x40040C08)
...
#define GPIO_PRT7_OUT      (*(volatile unsigned int*)0x40310380)
#define GPIO_PRT7_CFG      (*(volatile unsigned int*)0x403103C4)
#define GPIO_PRT7_INV      (*(volatile unsigned int*)0x4031038C)
