/***************************************************************** 
 *
 * FILE        : MPC564xBC_V0.3.h  ALPHA RELEASE
 * 
 * DESCRIPTION : This is the header file describing the register
 *               set for:
 *                 Bolero 3M (MPC564xB/C)
 *
 * COPYRIGHT   :(c) 2011, Freescale
 * 
 * VERSION     : 0.3 (Based on RM Rev2 Draft B)
 * DATE        : February 2011 
 * AUTHOR      : r19325
 * HISTORY     : Based on Bolero 512, Bolero 1.5M and MPC5668
 *  0.1 Jun10  : Initial release based on RM RevA, Ver 0.1
 *  0.2 Jul10  : Corrections based on RM Rev1 Draft D
 *  0.3 Feb11  : Corrections based on B1.5M header and RM R2 DraftB
 *
 *
 * This header file does not include definitions for flexray as the
...
struct SSCM_tag{
   ...
   union { /* SSCM Control (Base+0x0024)*/
        vuint32_t R;
        struct {
            vuint32_t :29;
            vuint32_t TFE:1;
...
struct PIT_tag {
    ...
    /* RTI Config Registers (Base + 0x00F0-0x00FF) */
     struct {
        ...
        union { /* RTI Timer Control (Offset+0x000C) */
            vuint32_t R;
            struct {
                vuint32_t :31;
                vuint32_t TIF:1;
    ...
    struct {
        ...
        union { /* PIT Timer Control (Offset+0x000C) */
            vuint32_t R;
            struct {
                vuint32_t :31;
                vuint32_t TIF:1;
...
struct ADC0_tag {
    ...
    union { /* ADC0 Channel Pending 1 (Base+0x0018) */
        ...
        struct {
            vuint32_t:1; /* vuint32_t EOC_CH63:1; */
            vuint32_t:1; /* vuint32_t EOC_CH62:1; */
            vuint32_t:1; /* vuint32_t EOC_CH61:1; */
    ...
    union { /* ADC0 Channel Interrupt Mask 1 (+0x0028) */
        vuint32_t R; /*      (For Standard Channels)            */
        struct {
            vuint32_t:1; /* vuint32_t CIM63:1; */
            vuint32_t:1; /* vuint32_t CIM62:1; */
            vuint32_t:1; /* vuint32_t CIM61:1; */
            vuint32_t CIM60:1;
            vuint32_t CIM59:1;
            vuint32_t CIM58:1;
            vuint32_t CIM57:1;
    ...
    union { /* ADC0 DMA Channel Select 1 (Base+0x0048) */
        vuint32_t R; /*      (for standard channels)            */
        struct {
            vuint32_t:1; /* vuint32_t DMA63:1; */
            vuint32_t:1; /* vuint32_t DMA62:1; */
            vuint32_t:1; /* vuint32_t DMA61:1; */
            vuint32_t DMA60:1;
            vuint32_t DMA59:1;
            vuint32_t DMA58:1;
            vuint32_t DMA57:1;
    ...
    union { /* ADC0 Presampling 1 (Base+0x0088) */
        ...
        struct {
            vuint32_t:1; /* vuint32_t PRES63:1; */
            vuint32_t:1; /* vuint32_t PRES62:1; */
            vuint32_t:1; /* vuint32_t PRES61:1; */
            vuint32_t PRES60:1;
            vuint32_t PRES59:1;
            vuint32_t PRES58:1;
            vuint32_t PRES57:1;
    ...
    union { /* ADC0 Normal Conversion Mask 1 (Base+0x00A8) */
        vuint32_t R; /*      (standard channels)                    */
        struct {
            vuint32_t:1; /* vuint32_t CH63:1; */
            vuint32_t:1; /* vuint32_t CH62:1; */
            vuint32_t:1; /* vuint32_t CH61:1; */
            vuint32_t CH60:1;
            vuint32_t CH59:1;
            vuint32_t CH58:1;
            vuint32_t CH57:1;
    ...
    union { /* ADC0 Channel Watchdog Select 7 (Base+0x02CC) */
        ...
        struct {
            vuint32_t:1;
            vuint32_t:3; /* vuint32_t WSEL_CH63:3; */
            vuint32_t:1;
            vuint32_t:3; /* vuint32_t WSEL_CH62:3; */
            vuint32_t:1;
            vuint32_t:3; /* vuint32_t WSEL_CH61:3; */
            vuint32_t:1;
    ...
    union { /* ADC0 Channel Watchdog Enable1 (Base++0x02E4) */
        vuint32_t R; /*      (standard channels)                     */
        struct {
            vuint32_t:1; /* vuint32_t CWEN63:1; */
            vuint32_t:1; /* vuint32_t CWEN62:1; */
            vuint32_t:1; /* vuint32_t CWEN61:1; */
            vuint32_t CWEN60:1;
            vuint32_t CWEN59:1;
            vuint32_t CWEN58:1;
            vuint32_t CWEN57:1;
    ...
    union { /* ADC0 Watchdog out of range 1 (Base+0x02F4) */
        vuint32_t R;
        struct {
            vuint32_t:1; /* vuint32_t AWORR_CH63:1; */
            vuint32_t:1; /* vuint32_t AWORR_CH62:1; */
            vuint32_t:1; /* vuint32_t AWORR_CH61:1; */
...
struct DSPI_tag{
    ...
    union { /* DSPI DSI Serilalisation Source (Base+0x00D4) */
        vuint32_t R;
        struct {
