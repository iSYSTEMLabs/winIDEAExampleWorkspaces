...
extern int TimerInterruptHandler(void);
...
// Define IMMEDIATE_INIT in compiler options if some immediate initialization is needed
// Implemet void ImmInit(); in custom source file.    
#ifdef IMMEDIATE_INIT
    ImmInit();
#endif
