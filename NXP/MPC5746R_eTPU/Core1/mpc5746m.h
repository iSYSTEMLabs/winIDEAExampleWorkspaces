/**************************************************************************
 * FILE NAME: mpc5746m.h                     COPYRIGHT (c) Freescale 2012 * 
 * REVISION:  1.6                                     All Rights Reserved *
 *                                                                        *
 * DESCRIPTION:                                                           *
 ...
 * ---   -----------  ---------    	---------------------                 *
 * 0.1a  D.MC & M.V   31-May-11    	Initial Prototype Release             *
 *                                                                        *
 * 0.1b  D.MC & M.V	  21-June-11 	- Fixed location of reserved0 areas   *
 *                                    in SIUL2, FEC, MC_CGM and GTMINT    *
 *                                  - Fixed bit field EIRE0 in SIUL2      *
 *                                  - Fixed LBIST and MBIST struct issue  *
 *									- Fixed MIB counter issue in FEC	  *
 *	 								- DMA: Changed DMA TCD register		  *
 *									  configuration to a struct			  *
 *									  -> changed name of BITER and CITER  *
 *										 bit fields						  * 
 *									  -> corrected signed bit fields      *
 *                                  - Known issues: module HSMIF missing  *
 *                                                                        *
 * 0.1c	 D.MC & M.V	  14-July-11	- updated base address of CGM		  *
 *                                  - Added reg IBDBG to I2C module       *
 *									- fixed base address of CMU_Flex	  *
 *                                  - Added RTI regs to PIT module        *
 *                                  - Added DMACHMUX instances            *
 *                                  - In SIUL2 fixed GPD reg sizes		  *
 *                                  - Added RCOSC tag                     *
 *									- Combined CTAR regs in DSPI to array *
 *									- in MCAN.CCCR: swapped ASM and CCE	  *
 *									- in SIUL2: Changed MSCOR to MSCR	  *
 *																		  *
 * 1.0	 D.MC & M.V	  16-Feb-11     - Fixed base address tags for SARADCs *
 *									- Fixed base address for SDADC_0	  *
 *									- Added SCR0 reg to SIUL2 module	  *
 *									- SIUL2: Edited OERC & ODC in MSCR	  *
 *									- WKPU: Removed registers, edited bits*
 *									- Included PASS module				  *
 *									- SIUL2: Fixed bitfield size of GPDI  *
 *									  & GPDO							  *
 *									- CGM: Fixed registers				  *
 *									- ME: Edited registers PS4 and PCTL31 *
 *									- PSI5: Fixed structure, edited GCR & *
 *										DOBCR							  *
 *									- RGM: Edited register PRST4		  *
 *									- MC_PCU: Fixed struct				  *
 *																		  *
 * 1.1	 D.MC & M.V	  01-Mar-12		- LINFlexD: Swapped bitfields DTF_RFE *
 *									  DRF_TFF in UARTSR					  *
 *									- SIUL2: Fixed size of SCR0			  *
 *									- Fixed base address of SAR1 & SAR4	  *
 *																		  *
 * 1.2	 D.MC & M.V	  05-Mar-12		- SIUL2: Fixed size of SCR0			  *
 *									- Fixed base addresses and names of	  *
 *									  CMU instances						  *
 *									- Added SWT_3 instance				  *
 *									- LINFlexD: Added LBKM bit to LINCR1  *
 *																		  *
 * 1.3	 D.MC & M.V	  12-Mar-12		- Fixed DIGRF tags					  *
 *									- DigRF: Fixed bit LVRXOP in LCR	  *
 *									- RGM: Fixed FRET register; added	  *
 *									  DRET & EROEC registers			  *
 *                                                                        *
 * 1.4	 D.MC & M.V   11-Apr-12		- SRX: Removed Channels 5 to 15 &	  *
 *									  removed references to SRX_0 from	  *
 *									  register names					  *
 *									- SIUL2: Fixed PGPDO, PGPDI & MPGPDO  *
 *									  registers, changed structure to form*
 *									  arrays for these registers		  *
 *																		  *
 * 1.5	 D.MC & M.V   11-Jun-12		- MC_CGM: Fixed size of bitfield DIV  *
 *									  in AC0_DC[5] register array		  *
 *									- MC_CGM: Added register for AC11	  *
 *									- PMCDIG: Added missing FEE_xx regs	  *
 *									- Renamed DigRF to LFAST			  *
 *									- DMA: Changed to more user friendly  *
 *									  format							  *
 *									- MCAN: Fixed bitfield RXF1S_F1GI	  *
 *																		  *
 * 1.6	 D.MC & M.V   13-Aug-12		- GTMINT: fixed 1s res locations:	  *
 *									  192x8-bit instead of 48x8-bit		  *
 *									- JTAGM: Fixed endianness			  *
 *																		  *
 * PLEASE REPORT ANY ERRORS & FINDINGS TO MARTIN VAUPEL					  *
 * (martin.vaupel@freescale.com)										  *
 *========================================================================*
 * COPYRIGHT:                                                             *
...
/*****************************Status and Control Registers**************************/
        ...
        union {                 /* ETPU_A Channel Interrupt Status */
            vuint32_t R;
            struct {
                vuint32_t CIS31:1;      /* Channel 31 Interrupt Status */
                vuint32_t CIS30:1;      /* Channel 30 Interrupt Status */
                vuint32_t CIS29:1;      /* Channel 29 Interrupt Status */
                vuint32_t CIS28:1;      /* Channel 28 Interrupt Status */
                vuint32_t CIS27:1;      /* Channel 27 Interrupt Status */
                vuint32_t CIS26:1;      /* Channel 26 Interrupt Status */
                vuint32_t CIS25:1;      /* Channel 25 Interrupt Status */
                vuint32_t CIS24:1;      /* Channel 24 Interrupt Status */
                vuint32_t CIS23:1;      /* Channel 23 Interrupt Status */
                vuint32_t CIS22:1;      /* Channel 22 Interrupt Status */
                vuint32_t CIS21:1;      /* Channel 21 Interrupt Status */
                vuint32_t CIS20:1;      /* Channel 20 Interrupt Status */
                vuint32_t CIS19:1;      /* Channel 19 Interrupt Status */
                vuint32_t CIS18:1;      /* Channel 18 Interrupt Status */
                vuint32_t CIS17:1;      /* Channel 17 Interrupt Status */
                vuint32_t CIS16:1;      /* Channel 16 Interrupt Status */
                vuint32_t CIS15:1;      /* Channel 15 Interrupt Status */
                vuint32_t CIS14:1;      /* Channel 14 Interrupt Status */
                vuint32_t CIS13:1;      /* Channel 13 Interrupt Status */
                vuint32_t CIS12:1;      /* Channel 12 Interrupt Status */
                vuint32_t CIS11:1;      /* Channel 11 Interrupt Status */
                vuint32_t CIS10:1;      /* Channel 10 Interrupt Status */
                vuint32_t CIS9:1;       /* Channel 9 Interrupt Status */
                vuint32_t CIS8:1;       /* Channel 8 Interrupt Status */
                vuint32_t CIS7:1;       /* Channel 7 Interrupt Status */
                vuint32_t CIS6:1;       /* Channel 6 Interrupt Status */
                vuint32_t CIS5:1;       /* Channel 5 Interrupt Status */
                vuint32_t CIS4:1;       /* Channel 4 Interrupt Status */
                vuint32_t CIS3:1;       /* Channel 3 Interrupt Status */
                vuint32_t CIS2:1;       /* Channel 2 Interrupt Status */
                vuint32_t CIS1:1;       /* Channel 1 Interrupt Status */
                vuint32_t CIS0:1;       /* Channel 0 Interrupt Status */
            } B;
        } CISR_A;

        union {                 /* ETPU_B Channel Interrupt Status */
            vuint32_t R;
            struct {
                vuint32_t CIS31:1;      /* Channel 31 Interrupt Status */
                vuint32_t CIS30:1;      /* Channel 30 Interrupt Status */
        ...
        union {                 /* ETPU_A Interrupt Overflow Status */
            vuint32_t R;
            struct {
                vuint32_t CIOS31:1;     /* Channel 31 Interrupt Overflow Status */
                vuint32_t CIOS30:1;     /* Channel 30 Interrupt Overflow Status */
                vuint32_t CIOS29:1;     /* Channel 29 Interrupt Overflow Status */
                vuint32_t CIOS28:1;     /* Channel 28 Interrupt Overflow Status */
                vuint32_t CIOS27:1;     /* Channel 27 Interrupt Overflow Status */
                vuint32_t CIOS26:1;     /* Channel 26 Interrupt Overflow Status */
                vuint32_t CIOS25:1;     /* Channel 25 Interrupt Overflow Status */
                vuint32_t CIOS24:1;     /* Channel 24 Interrupt Overflow Status */
                vuint32_t CIOS23:1;     /* Channel 23 Interrupt Overflow Status */
                vuint32_t CIOS22:1;     /* Channel 22 Interrupt Overflow Status */
                vuint32_t CIOS21:1;     /* Channel 21 Interrupt Overflow Status */
                vuint32_t CIOS20:1;     /* Channel 20 Interrupt Overflow Status */
                vuint32_t CIOS19:1;     /* Channel 19 Interrupt Overflow Status */
                vuint32_t CIOS18:1;     /* Channel 18 Interrupt Overflow Status */
                vuint32_t CIOS17:1;     /* Channel 17 Interrupt Overflow Status */
                vuint32_t CIOS16:1;     /* Channel 16 Interrupt Overflow Status */
                vuint32_t CIOS15:1;     /* Channel 15 Interrupt Overflow Status */
                vuint32_t CIOS14:1;     /* Channel 14 Interrupt Overflow Status */
                vuint32_t CIOS13:1;     /* Channel 13 Interrupt Overflow Status */
                vuint32_t CIOS12:1;     /* Channel 12 Interrupt Overflow Status */
                vuint32_t CIOS11:1;     /* Channel 11 Interrupt Overflow Status */
                vuint32_t CIOS10:1;     /* Channel 10 Interrupt Overflow Status */
                vuint32_t CIOS9:1;      /* Channel 9 Interrupt Overflow Status */
                vuint32_t CIOS8:1;      /* Channel 8 Interrupt Overflow Status */
                vuint32_t CIOS7:1;      /* Channel 7 Interrupt Overflow Status */
                vuint32_t CIOS6:1;      /* Channel 6 Interrupt Overflow Status */
                vuint32_t CIOS5:1;      /* Channel 5 Interrupt Overflow Status */
                vuint32_t CIOS4:1;      /* Channel 4 Interrupt Overflow Status */
                vuint32_t CIOS3:1;      /* Channel 3 Interrupt Overflow Status */
                vuint32_t CIOS2:1;      /* Channel 2 Interrupt Overflow Status */
                vuint32_t CIOS1:1;      /* Channel 1 Interrupt Overflow Status */
                vuint32_t CIOS0:1;      /* Channel 0 Interrupt Overflow Status */
            } B;
        } CIOSR_A;

        union {                 /* ETPU_B Interrupt Overflow Status */
            vuint32_t R;
            struct {
                vuint32_t CIOS31:1;     /* Channel 31 Interrupt Overflow Status */
                vuint32_t CIOS30:1;     /* Channel 30 Interrupt Overflow Status */
        ...
        union {                 /* ETPU_A Channel Interrupt Enable */
            vuint32_t R;
            struct {
                vuint32_t CIE31:1;      /* Channel 31 Interrupt Enable */
                vuint32_t CIE30:1;      /* Channel 30 Interrupt Enable */
                vuint32_t CIE29:1;      /* Channel 29 Interrupt Enable */
                vuint32_t CIE28:1;      /* Channel 28 Interrupt Enable */
                vuint32_t CIE27:1;      /* Channel 27 Interrupt Enable */
                vuint32_t CIE26:1;      /* Channel 26 Interrupt Enable */
                vuint32_t CIE25:1;      /* Channel 25 Interrupt Enable */
                vuint32_t CIE24:1;      /* Channel 24 Interrupt Enable */
                vuint32_t CIE23:1;      /* Channel 23 Interrupt Enable */
                vuint32_t CIE22:1;      /* Channel 22 Interrupt Enable */
                vuint32_t CIE21:1;      /* Channel 21 Interrupt Enable */
                vuint32_t CIE20:1;      /* Channel 20 Interrupt Enable */
                vuint32_t CIE19:1;      /* Channel 19 Interrupt Enable */
                vuint32_t CIE18:1;      /* Channel 18 Interrupt Enable */
                vuint32_t CIE17:1;      /* Channel 17 Interrupt Enable */
                vuint32_t CIE16:1;      /* Channel 16 Interrupt Enable */
                vuint32_t CIE15:1;      /* Channel 15 Interrupt Enable */
                vuint32_t CIE14:1;      /* Channel 14 Interrupt Enable */
                vuint32_t CIE13:1;      /* Channel 13 Interrupt Enable */
                vuint32_t CIE12:1;      /* Channel 12 Interrupt Enable */
                vuint32_t CIE11:1;      /* Channel 11 Interrupt Enable */
                vuint32_t CIE10:1;      /* Channel 10 Interrupt Enable */
                vuint32_t CIE9:1;       /* Channel 9 Interrupt Enable */
                vuint32_t CIE8:1;       /* Channel 8 Interrupt Enable */
                vuint32_t CIE7:1;       /* Channel 7 Interrupt Enable */
                vuint32_t CIE6:1;       /* Channel 6 Interrupt Enable */
                vuint32_t CIE5:1;       /* Channel 5 Interrupt Enable */
                vuint32_t CIE4:1;       /* Channel 4 Interrupt Enable */
                vuint32_t CIE3:1;       /* Channel 3 Interrupt Enable */
                vuint32_t CIE2:1;       /* Channel 2 Interrupt Enable */
                vuint32_t CIE1:1;       /* Channel 1 Interrupt Enable */
                vuint32_t CIE0:1;       /* Channel 0 Interrupt Enable */
            } B;
        } CIER_A;

        union {                 /* ETPU_B Channel Interrupt Enable */
            vuint32_t R;
            struct {
                vuint32_t CIE31:1;      /* Channel 31 Interrupt Enable */
                vuint32_t CIE30:1;      /* Channel 30 Interrupt Enable */
...
/**************************************************************************/
    struct JTAGM_tag {
        ...
        union {
            vuint32_t R;
            struct {
                // vuint32_t overrun:1;              /* LFAST mode */
                // vuint32_t:1;                      
    ...
    struct MC_ME_tag {
        ...
        union {
            ...
            struct {
                ...
                vuint32_t S_PSI5_A0:1;
                  vuint32_t:3;
                vuint32_t S_FlexRay_A00:1;
                  vuint32_t:2;
                vuint32_t S_SENT_A0:1;
                  vuint32_t:2;
                vuint32_t S_IIC_A0:1;
                  vuint32_t:1;
                vuint32_t S_DSPI_A0:1;
                vuint32_t S_DSPI_A1:1;
                vuint32_t S_DSPI_A2:1;
                  vuint32_t:1;
            } B;
        } PS3;
        ...
        union {
            ...
            struct {
                vuint32_t:3;
                vuint32_t S_ADCSD_B0:1;
                vuint32_t S_ADCSD_B1:1;
                vuint32_t S_ADCSD_B2:1;
                  vuint32_t:19;
                vuint32_t S_CRC_B0:1;
                  vuint32_t:1;
                vuint32_t S_DMA_CH_MUX1:1;
                  vuint32_t:4;
            } B;
        } PS5;
        ...
        union {
            ...
            struct {
                vuint32_t:3;
                vuint32_t S_LINFlexD_B0:1;
                vuint32_t S_LINFlexD_B1:1;
                  vuint32_t:27;
            } B;
        } PS6;
        ...
        union {
            ...
            struct {
                vuint32_t:2;
                vuint32_t S_ADCSAR_B0:1;
                vuint32_t S_ADCSAR_B1:1;
                vuint32_t S_ADCSAR_B2:1;
                vuint32_t S_ADCSAR_B3:1;
                vuint32_t S_ADCSAR_B4:1;
                  vuint32_t:9;
                vuint32_t S_PSI5_B0:1;
                  vuint32_t:6;
                vuint32_t S_SENT_B0:1;
                  vuint32_t:4;
                vuint32_t S_DSPI_B2:1;
                vuint32_t S_DSPI_B1:1;
                vuint32_t S_DSPI_B0:1;
                  vuint32_t:1;
            } B;
        } PS7;
...
#define ETPU          (*(volatile struct ETPU_tag *)      0xFFCC0000UL)
...
#define FLEXRAY_0     (*(volatile struct FR_tag *)        0xFFE50000UL)   
#define SRX_0         (*(volatile struct SRX_tag *)       0xFFE5C000UL)
#define IIC_0         (*(volatile struct I2C_tag *)       0xFFE68000UL)
...
#define DMACHMUX_0    (*(volatile struct DMACHMUX_tag *)  0xFFF6C000UL)
#define DMACHMUX_1    (*(volatile struct DMACHMUX_tag *)  0xFFF6C200UL)
#define DMACHMUX_2    (*(volatile struct DMACHMUX_tag *)  0xFFF6C400UL)
#define DMACHMUX_3    (*(volatile struct DMACHMUX_tag *)  0xFFF6C600UL)
#define DMACHMUX_4    (*(volatile struct DMACHMUX_tag *)  0xFFF6C800UL)
#define DMACHMUX_5    (*(volatile struct DMACHMUX_tag *)  0xFFF6CA00UL)
...
#define ETPU_DATA_RAM       (*( uint32_t *)               0xFFCC8000UL)
