...
extern void SW_INT_2_isr(void); /* Vector #   1 Software setable flag 1         SSCIR0[CLR1] */
extern void TimerInterruptHandler_2(void);     /* Vector # 226 Periodic Interrupt Timer (PIT0) PIT_1_TFLG0[TIF] */

void (dummy) (void);

#pragma ghs section rodata =".intc_sw_mode_isr_vector_table"

const uint32_t intc_sw_mode_isr_vector_table_2[] = {
...
(uint32_t) &TimerInterruptHandler_2, /* Vector # 228 Periodic Interrupt Timer (PIT2) PIT_1_TFLG2[TIF] */
