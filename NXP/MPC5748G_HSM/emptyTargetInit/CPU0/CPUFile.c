...
void peri_clock_gating (void) {
  ...
  MC_ME.RUN_PC[2].R       = 0x000000FE; /* config. peri clock for all RUN modes */
  MC_ME.RUN_PC[3].R       = 0x000000FE; /* config. peri clock for all RUN modes */
  MC_ME.RUN_PC[4].R       = 0x000000FE; /* config. peri clock for all RUN modes */
  MC_ME.RUN_PC[5].R       = 0x000000FE; /* config. peri clock for all RUN modes */
  MC_ME.RUN_PC[6].R       = 0x000000FE; /* config. peri clock for all RUN modes */
  MC_ME.RUN_PC[7].R       = 0x000000FE; /* Run Peri. Cfg 7 settings: run in DRUN, RUN3 modes */
