...
#define MCG_C1_FRDIV 3                                                // FLL External Reference Divider
#define MCG_C1_IREFS 2                                                // Internal Reference Select
#define MCG_C2 (*(volatile unsigned char*)0x40064001)
#define MCG_C2_EREFS0 2                                               // External Reference Select
#define MCG_C2_HGO0 3                                                 // High Gain Oscillator Select
#define MCG_C2_RANGE0 4                                               // Frequency Range Select
#define MCG_C2_LP 1                                                   // Low Power Select
#define MCG_C4 (*(volatile unsigned char*)0x40064003)
#define MCG_C4_DMX32 7                                                // DCO Maximum Frequency with 32.768 kHz Reference
#define MCG_C4_DRST_DRS 5                                             // DCO Range Select
#define MCG_C6 (*(volatile unsigned char*)0x40064005)
#define MCG_C6_PLLS 6                                                 // PLL Select
#define MCG_C7 (*(volatile unsigned char*)0x4006400C)                 
#define MCG_C7_OSCSEL 0                                               // Oscillator select
// Main clock generator status register
#define MCG_S (*(volatile unsigned char*)0x40064006)                    
#define MCG_S_OSCINIT0 1                                              // OSC Initialization
#define MCG_S_CLKST 2
// Oscillator registers
#define OSC_CR (*(volatile unsigned char*)0x40066000)                 
#define OSC_CR_ERCLKEN 7                                              // OSC Control Register                                             
...
/*
  Timer registers   
*/
#define PIT0_LDVAL0 (*(volatile unsigned int*)0x4002D100)             // Timer Load Value Register
#define PIT0_TCTRL0 (*(volatile unsigned int*)0x4002D108)             // Timer Control Register
#define PIT0_TCTRL0_TIE 1                                             // Timer Interrupt Enable
#define PIT0_TCTRL0_TEN 0                                             // Timer Enable
#define PIT0_MCR (*(volatile unsigned int*)0x4002D000)                // PIT Module Control Register                
#define PIT0_MCR_MDIS 1                                               // Module Disable
#define PIT0_TFLG (*(volatile unsigned int*)0x4002D10C)               // Timer flag register
#define PIT0_TFLG_TIF 0

/*
  System Integration Module  
*/
#define SIM_SCGC6 (*(volatile unsigned int*)0x4003F03C)               // System Clock Gating Control Register 6
#define SIM_SCGC6_PIT0 13                                             // PIT0 Clock enable
#define SIM_SCGC6_PORTJ 23                                            // PCTLJ Clock Gate Control
#define SIM_CLKDIV1 (*(volatile unsigned int*)0x4003F044)             // System Clock Divider Register 1
#define SIM_CLKDIV1_CLKDIVBUS 24                                        // Bus Clock divider

/*
  GPIO registers   
*/
#define GPIOJ_PDDR (*(volatile unsigned char*)0x400FF095)
#define GPIOJ_PTOR (*(volatile unsigned char*)0x400FF08D)
#define GPIOJ_PSOR (*(volatile unsigned char*)0x400FF085) 
#define GPIOJ_PIN 4
#define PORTJ_PCR4 (*(volatile unsigned int*)0x40037010)
#define PORTJ_PCR4_MUX 8

/*
  NVIC registers   
*/
#define NVIC_INT_0_31_SET_EN (*(volatile unsigned int*)0xE000E100)
#define NVIC_INT_0_31_CLR_EN (*(volatile unsigned int*)0xE000E180)
#define NIVC_PIT0 11
