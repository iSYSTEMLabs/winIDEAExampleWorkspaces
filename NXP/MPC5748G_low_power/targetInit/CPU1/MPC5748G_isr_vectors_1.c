...
extern void TimerInterruptHandler_1(void);     /* Vector # 226 Periodic Interrupt Timer (PIT0) PIT_1_TFLG0[TIF] */

void (dummy) (void);

#pragma ghs section rodata =".intc_sw_mode_isr_vector_table"

const uint32_t intc_sw_mode_isr_vector_table_1[] = {
...
(uint32_t) &TimerInterruptHandler_1, /* Vector # 227 Periodic Interrupt Timer (PIT1) PIT_1_TFLG1[TIF] */
