...
/*WDT Registers*/
#define WDOG1_WMCR (*(volatile uint32_t *) 0x400B8000)
#define WDOG3_CS  (*(volatile uint32_t *) 0x400BC000)
#define WDOG3_CNT (*(volatile uint32_t *) 0x400BC004)
#define WDOG3_TOVAL (*(volatile uint32_t *) 0x400BC008)

/*CCM registers*/
#define CCM_ANALOG_MISC0_CLR (*(volatile uint32_t *) 0x400D8158)
#define CCM_ANALOG_MISC0_SET (*(volatile uint32_t *) 0x400D8154)
#define CCM_CCGR1 (*(volatile uint32_t *) 0x400FC06C)

/*XTALOSC24M registers*/
#define XTALOSC24M_LOWPWR_CTRL (*(volatile uint32_t *) 0x400D8270)
#define XTALOSC24M_LOWPWR_CTRL_CLR (*(volatile uint32_t *) 0x400D8278)
...
#define GPT1_ICR1 (*(volatile uint32_t *) 0x401EC01C)
#define GPT1_CNT (*(volatile uint32_t *) 0x401EC024)

/*GPIO registers*/
#define IOMUXC_SW_MUX_CTL_PAD_GPIO_AD_B1_09 (*(volatile uint32_t *) 0x401F8120)
