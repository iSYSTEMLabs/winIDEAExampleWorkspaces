...
/*STM 0*/
#define STM_0_CR            (*(unsigned long volatile*)0x40274000)
#define STM_0_CNT           (*(unsigned long volatile*)(0x40274000+0x4))
#define STM_0_CCR0          (*(unsigned long volatile*)0x40274000+0x10)
#define STM_0_CIR0          (*(unsigned long volatile*)0x40274000+0x14)
#define STM_0_CMP0          (*(unsigned long volatile*)0x40274000+0x18)
...
#define STM_0_CNTS ((STM_0_CNTs *)(0x40274000+0x4))
