...
##---------------------------------------------------------------------------
    ...
    .LONG _start             # Code starts at __start
...
##---------------------------------------------------------------------------
## Disable Watchdog  
## May or may not be needed because Watchdog could be off in the shadow block
##---------------------------------------------------------------------------
    ...
    lis     r6,0xFFF3
    ori     r6,r6,0x8000
    lis     r7,0x8000                            # Old value 0xFF00
    ori     r7,r7,0x10A
    stw     r7,0x0(r6)                           # WEN = 0	
...
#Initializing data does not work. Nothing gets loaded into the flash reseved for memory initialization.
