...
void enableSecondaryCores()
{
  ...
  MC_ME.CCTL[1].R = 0x00FE;   // enable core 1 (Z7) in all modes
  MC_ME.CCTL[3].R = 0x00FE;   // enable core 2 (Z7) in all modes 

  MC_ME.CADDR[1].R = 0x00FF0001; // Set Start address for core 1 (Z7). Will reset and start
  MC_ME.CADDR[3].R = 0x01020001; // Set Start address for core 2 (Z7). Will reset and start 
