...
void (* const g_pfnVectors[])(void) =
{
    ...
    TimerInterruptHandler,                      // Timer 1 subtimer B
...
//     stackreg = (unsigned long)&_stack_top;
  ...
  // Disable watchdog
  #define WDOG_CS1 *((volatile BYTE *)0x40052000)
  #define WDOG_CNT *((volatile WORD *)0x40052002)
  
  __asm__("cpsid i"); //disable interrupts
  //All of the bits in this register can be written only once after a reset.
  #define WDOG_CS1    *((volatile BYTE *)0x40052000)
  #define WDOG_CS2    *((volatile BYTE *)0x40052001)
  #define WDOG_CNT    *((volatile WORD *)0x40052002)
  #define WDOG_TOVAL  *((volatile WORD *)0x40052004)
  #define WDOG_WIN    *((volatile WORD *)0x40052006)
  
  // This entire sequence must be used for WDOG settings to stick!!
  WDOG_CNT = 0x20C5; // Will unlock watchdog
  WDOG_CNT = 0x28D9; // Will unlock watchdog
  WDOG_TOVAL = 1000; // setting timeout value
  WDOG_CS2 = 0x41 ;  // Clear Interrupt & Set  1 kHz internal low-power oscillator (LPOCLK).
  WDOG_CS1 = 1 << 5; // Will disable watchdog but allow update
