...
#***************************************************************************/
 ...
 #            ************* 
    ...
    .equ  INTC_0_IACKR0, 0xFC040020  #  CPU 2 INTC 1 Interrupt Acknowledge Reg address
    .equ  INTC_0_EOIR0,  0xFC040030  #  CPU 2 INTC 1 End Of Interrupt Reg address
...
prolog_core_2:                     # PROLOGUE 
    ...
    se_stw   r3,  0x0C (r1)                                           
    e_lis    r3,  INTC_0_IACKR0@ha    # Store address of IACKR in r3
    e_lwz    r3,  INTC_0_IACKR0@l(r3) # Store contents of IACKR in r3 (this is vector table address)                                       
...
epilog_core_0:                     # EPILOGUE
    ...
    mbar     0                     # Ensure interrupt flag has finished clearing
                                   ...
                                   # INTC_EOIR0, 
#    e_lis    r3,  INTC_0_EOIR0@ha # Load upper half of EIOR address to r3                                                                                                                                                 
#    e_li     r4,  0x0  
 ...
 #   se_stw   r4,  INTC_0_EOIR0@l(r3)# Store to  EIOR2, informing INTC for lowering priority address to r3 and

    e_lis    r3,  INTC_0_EOIR0@ha    # form adjusted upper half of INTC_EOIR2 address
    e_li     r4,  0x0                # form 0 to write to INTC_EOIRn
    wrteei   0                       # disable processor recognition of interrupts
    e_stw    r4,  INTC_0_EOIR0@l(r3) # store to INTC_EOIRn, informing INTC to lower
