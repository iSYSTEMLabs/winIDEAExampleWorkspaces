...
const resetfuncptr  CPU0_resetvector = __start;       //0x4 - CPU reset vector
const resetfuncptr  CPU1_resetvector = __start;       //0x4 - CPU reset vector
/*
const unsigned long CFG_bits0        = 0xFFFFFFFF;    //0x8 - configuration bits
const unsigned long CFG_bits1        = 0xFFFFFFFF;    //0xC - configuration bits
*/
__asm void usr_init()
{
  nofralloc
