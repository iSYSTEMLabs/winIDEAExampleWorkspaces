...
#define MC_ME_PERIPHERAL_DOMAIN_GS             (*(unsigned volatile int *)   0x710E0000)
#define MC_ME_PERIPHERAL_DOMAIN_MCTL           (*(unsigned volatile int *)   0x710E0004)
#define MC_ME_PERIPHERAL_DOMAIN_ME             (*(unsigned volatile int *)   0x710E0008)
#define MC_ME_PERIPHERAL_DOMAIN_CCTL0          (*(unsigned volatile short *) 0x710E01C6)
#define MC_ME_PERIPHERAL_DOMAIN_CCTL1          (*(unsigned volatile short *) 0x710E01C4)
#define MC_ME_PERIPHERAL_DOMAIN_CADDR0         (*(unsigned volatile int *)   0x710E01E0)
#define MC_ME_PERIPHERAL_DOMAIN_CADDR1         (*(unsigned volatile int *)   0x710E01E4)
