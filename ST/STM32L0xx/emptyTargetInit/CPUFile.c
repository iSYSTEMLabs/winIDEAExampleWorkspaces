#include "STM32L0.h"
#include "STM32L0_lpDriver.h"


void initTimer()
{
  RCC_APB1ENR |= (0x1 << TIM2EN);// enable timer TIM2, clock is 64 MHz
...
void CPU_Init()
{
  ...
  value |= (0 << PPRE2);  // Set APB2 divider to 16
  value |= (0 << HPRE);   // Set AHB divider to 1
  RCC_CFGR = value;
