...
(uint32_t) &dummy, /* Vector #  24 Software setable flag 24 SSCIR0[CLR24] */
(uint32_t) &dummy, /* Vector #  25 Software setable flag 25 SSCIR0[CLR25] */
(uint32_t) &dummy, /* Vector #  26 Software setable flag 26 SSCIR0[CLR26] */
(uint32_t) &dummy, /* Vector #  27 Software setable flag 27 SSCIR0[CLR27]*/
(uint32_t) &dummy, /* Vector #  28 Software setable flag 28 SSCIR0[CLR28]*/
(uint32_t) &dummy, /* Vector #  29 Software setable flag 29 SSCIR0[CLR29]*/
(uint32_t) &dummy, /* Vector #  30 Software setable flag 30 SSCIR0[CLR30]*/
(uint32_t) &dummy, /* Vector #  31 Software setable flag 31 SSCIR0[CLR31]*/
...
(uint32_t) &dummy, /* Vector #  85 eDMA Channel 31 DMA_INTL[INT32]*/
(uint32_t) &dummy, /* Vector #  86 eDMA Channel 31 DMA_INTL[INT33]*/
(uint32_t) &dummy, /* Vector #  87 eDMA Channel 31 DMA_INTL[INT34]*/
(uint32_t) &dummy, /* Vector #  88 eDMA Channel 31 DMA_INTL[INT35]*/
...
(uint32_t) &dummy, /* Vector # 187 AMU DMA interrupt for AMU channel 1 STCFG1[WDMA]   */
(uint32_t) &dummy, /* Vector # 188 */
(uint32_t) &dummy, /* Vector # 189 AMU DMA interrupt for AMU channel 0 STCFG0[WDMA]   */
(uint32_t) &dummy, /* Vector # 190 AMU DMA interrupt for AMU channel 1 STCFG1[WDMA]   */
(uint32_t) &dummy, /* Vector # 191 AMU Error interrupt for AMU channel 0 STCFG0[EINT] */
(uint32_t) &dummy, /* Vector # 192 AMU Error interrupt for AMU channel 1 STCFG1[EINT]*/
...
(uint32_t) &dummy, /* Vector # 225 Real Time Counter (API) API */
(uint32_t) &TimerInterruptHandler, /* Vector # 226 Periodic Interrupt Timer 0 (PIT_0) Channel 0 PIT_0_TFLG0[TIF] */
(uint32_t) &dummy, /* Vector # 227 Periodic Interrupt Timer 0 (PIT_0) Channel 1 PIT_0_TFLG1[TIF] */
(uint32_t) &dummy, /* Vector # 228 Periodic Interrupt Timer 0 (PIT_0) Channel 2 PIT_0_TFLG2[TIF] */
(uint32_t) &dummy, /* Vector # 229 Periodic Interrupt Timer 0 (PIT_0) Channel 3 PIT_0_TFLG3[TIF] */
(uint32_t) &dummy, /* Vector # 230 Periodic Interrupt Timer 0 (PIT_0) Channel 4 PIT_0_TFLG4[TIF] */
(uint32_t) &dummy, /* Vector # 231 Periodic Interrupt Timer 0 (PIT_0) Channel 5 PIT_0_TFLG5[TIF] */
(uint32_t) &dummy, /* Vector # 232 Periodic Interrupt Timer 0 (PIT_0) Channel 6 PIT_0_TFLG6[TIF] */
(uint32_t) &dummy, /* Vector # 233 Periodic Interrupt Timer 0 (PIT_0) Channel 7 PIT_0_TFLG7[TIF] */
...
(uint32_t) &RtiTimerInterruptHandler, /* Vector # 239 Periodic Interrupt Timer 0 (PIT_0) PIT_0_RTI_TFLG[TIF] */
(uint32_t) &dummy, /* Vector # 240 Periodic Interrupt Timer 1 (PIT_1) PIT_1_TFLG0[TIF]    */
(uint32_t) &dummy, /* Vector # 241 Periodic Interrupt Timer 1 (PIT_1) PIT_1_TFLG1[TIF]    */
(uint32_t) &dummy, /* Vector # 242 XOSC counter XOSC_CTL[I_OSC]                           */
...
(uint32_t) &dummy, /* Vector # 754  */
(uint32_t) &dummy, /* Vector # 755  */
(uint32_t) &dummy, /* Vector # 756  */
(uint32_t) &dummy, /* Vector # 757  */
(uint32_t) &dummy, /* Vector # 758  */
(uint32_t) &dummy, /* Vector # 759  */
(uint32_t) &dummy, /* Vector # 760  */
(uint32_t) &dummy, /* Vector # 761  */
(uint32_t) &dummy, /* Vector # 762  */
(uint32_t) &dummy, /* Vector # 763  */
(uint32_t) &dummy, /* Vector # 764  */
(uint32_t) &dummy, /* Vector # 765  */
(uint32_t) &dummy, /* Vector # 766  */
(uint32_t) &dummy, /* Vector # 767  */
(uint32_t) &dummy, /* Vector # 768  */
(uint32_t) &dummy, /* Vector # 769  */
(uint32_t) &dummy, /* Vector # 770  */
(uint32_t) &dummy, /* Vector # 771  */
(uint32_t) &dummy, /* Vector # 772  */
(uint32_t) &dummy, /* Vector # 773  */
(uint32_t) &dummy, /* Vector # 774  */
(uint32_t) &dummy, /* Vector # 775  */
(uint32_t) &dummy, /* Vector # 776  */
(uint32_t) &dummy, /* Vector # 777  */
(uint32_t) &dummy, /* Vector # 778  */
(uint32_t) &dummy, /* Vector # 779  */
(uint32_t) &dummy, /* Vector # 780  */
(uint32_t) &dummy, /* Vector # 781  */
(uint32_t) &dummy, /* Vector # 782  */
(uint32_t) &dummy, /* Vector # 783  */
(uint32_t) &dummy, /* Vector # 784  */
(uint32_t) &dummy, /* Vector # 785  */
(uint32_t) &dummy, /* Vector # 786  */
(uint32_t) &dummy, /* Vector # 787  */
(uint32_t) &dummy, /* Vector # 788  */
(uint32_t) &dummy, /* Vector # 789  */
(uint32_t) &dummy, /* Vector # 790  */
(uint32_t) &dummy, /* Vector # 791  */
(uint32_t) &dummy, /* Vector # 792  */
(uint32_t) &dummy, /* Vector # 793  */
(uint32_t) &dummy, /* Vector # 794  */
(uint32_t) &dummy, /* Vector # 795  */
(uint32_t) &dummy, /* Vector # 796  */
(uint32_t) &dummy, /* Vector # 797  */
(uint32_t) &dummy, /* Vector # 798  */
(uint32_t) &dummy, /* Vector # 799  */
(uint32_t) &dummy, /* Vector # 800  */
(uint32_t) &dummy, /* Vector # 801  */
(uint32_t) &dummy, /* Vector # 802  */
...
(uint32_t) &dummy, /* Vector # 900  */
(uint32_t) &dummy, /* Vector # 901  */
(uint32_t) &dummy, /* Vector # 902  */
(uint32_t) &dummy, /* Vector # 903  */
(uint32_t) &dummy, /* Vector # 904  */
(uint32_t) &dummy, /* Vector # 905  */
