...
init_L2RAM:
   lis r11,__RAM_START_ADDR@h // base address of the L2SRAM, 64-bit word aligned
   ori r11,r11,__RAM_START_ADDR@l  // not needed for this address but could be forothers
...
init_l2ram_loop:
   stmw r16,0(r11) // write all 32 GPRs to L2SRAM
   addi r11,r11,64 // inc the ram ptr; 32 GPRs * 4 bytes = 128
