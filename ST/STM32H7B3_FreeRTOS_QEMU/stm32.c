...
void targetInit()
{
  ...
  unsigned long dwTempValue = System_Control_Space_System_Control_Block.AIRCR.R;
  dwTempValue &= 0xF8FF;
  
  // Set 4 bits for preemption priority
  System_Control_Space_System_Control_Block.AIRCR.R |= dwTempValue | (0x3 << 8) | (0x5FA << 16);
