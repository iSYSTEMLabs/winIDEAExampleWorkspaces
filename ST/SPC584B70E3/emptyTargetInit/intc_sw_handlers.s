...
#=========================================================================*/
    ...
    .equ  INTC_IACKR, 0xF4044028  # Interrupt Acknowledge Register address
    .equ  INTC_EOIR,  0xF4044038  # End Of Interrupt Register address
...
prolog:                           # PROLOGUE 
    ...
    e_bl InterruptHandler                 # Branch to ISR, but return here
