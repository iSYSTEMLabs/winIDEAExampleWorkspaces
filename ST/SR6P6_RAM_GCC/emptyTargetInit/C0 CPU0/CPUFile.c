...
void CopyDMECode()
{
  unsigned long dwStart = 0x64400000;
...
void CopyDSPHCode()
{
  unsigned long dwStart = 0x64410000;
  unsigned long dwEnd = dwStart + 0x00010000;
...
void startC0_CPU1()
{
  volatile unsigned long g_dwResetHandler = C0_CPU1_RAM_START_ADDR | 0x400;
...
void startC1()
{
  volatile unsigned long g_dwResetHandler0 = C1_CPU0_RAM_START_ADDR | 0x400;
  volatile unsigned long g_dwResetHandler1 = C1_CPU1_RAM_START_ADDR | 0x400;
...
void startC2()
{
  volatile unsigned long g_dwResetHandler0 = C2_CPU0_RAM_START_ADDR | 0x400;
  volatile unsigned long g_dwResetHandler1 = C2_CPU1_RAM_START_ADDR | 0x400;
