...
#define WKUP_PSC0_MDCTL_LPSC_DMSC     (*(volatile unsigned int*)0x42000A04)
#define WKUP_PSC0_MDCTL_LPSC_DEBUG2DMSC (*(volatile unsigned int*)0x42000A08)
