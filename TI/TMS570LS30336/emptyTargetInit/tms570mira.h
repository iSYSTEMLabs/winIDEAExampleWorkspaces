...
#define PSPWRDWNCLR0 *(volatile unsigned long *)0xFFFFE0A0
#define PSPWRDWNCLR1 *(volatile unsigned long *)0xFFFFE0A4
#define PSPWRDWNCLR2 *(volatile unsigned long *)0xFFFFE0A8
#define PSPWRDWNCLR3 *(volatile unsigned long *)0xFFFFE0AC
