...
#endif
#ifndef LIBRARIES
#define LIBRARIES       0xa0012000      /* start address of libraries locate group */
#endif
#ifndef INTTAB
#define INTTAB          0xa0010000      /* start address of interrupt table */
#endif
#ifndef TRAPTAB
#define TRAPTAB         0xa0011000      /* start address of trap table */
#endif
#ifndef CSA_START
...
derivative tc277
{
        ...
        memory pflash2
        {
                ...
                size = 0x10000;
                type = rom;
                map (dest=bus:tc:fpi_bus, dest_offset=0xa0010000, size=0x10000);
        }
